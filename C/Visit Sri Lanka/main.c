...
int main() {
    ...
    printf("\nEnter the District Name You Would Like To Visit: ");
    scanf("%s", district);
    ...
    if (strcmp(district, "Ampara") == 0) {
        ...
        printf(
                "01. Hotel For U Saliya Garden\n"
                "02. Salubrious Resort\n"
                "03. Hotel White House\n"
            );
        ...
        printf(
                "01. Cafe Aroma Inn\n"
                "02. Hotel Travellers Nest Kandy\n"
                "03. The Radh Hotel\n"
            );
        ...
        printf(
                "01. Bogala Village Eco Resort\n"
                "02. The Grand Walawwa\n"
                "03. Heaven Hides Narangala\n"
            );
        ...
        printf(
            "\n About: Mannar Fort is located on Mannar Island, Sri Lanka. It was built by Portuguese in 1560 and christened São Jorge. The fort fell to the Dutch in 1658, and they rebuilt the fort in 1696. In 1795 the British occupied the fort following the surrender by the Dutch. \n"
            );
        }
        ...
        else if (strcmp(place, "Doric_Bungalow") == 0) {
                printf(
            "\n About: The Doric Bungalow at Arippu East, Mannar, Sri Lanka, was the residence of the first British Governor of Ceylon. \n"
            );
        }
        else if (strcmp(place, "Vankalai_Sanctuary") == 0) {
                printf(
            "\n About: Vankalai Sanctuary (8°56'N 079°55'E) is located North-West of Sri Lanka in the District of Mannar. \n"
            );
        }
        ...
        printf(
                "01. Lakegala Resort\n"
                "02. The Covanro Sigiriya\n"
                "03. Amaya Lake Dambulla\n"
            );
        ...
        printf(
                "01. Elegant Green Beach Resort\n"
                "02. Mrd Beach Hotel\n"
                "03. Blue Sand Beach Resort\n"
            );
